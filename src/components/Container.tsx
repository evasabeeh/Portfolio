  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.evasabeeh.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.evasabeeh.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Eva Sabeeh" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-2xl font-semibold">Eva Sabeeh</span>
        </Link>
